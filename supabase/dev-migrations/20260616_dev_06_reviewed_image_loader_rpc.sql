-- Dev-only RPC for loading approved reviewed images after dry-run review.
-- Keep this out of production migrations until the review/image model is
-- promoted with an explicit production plan.
