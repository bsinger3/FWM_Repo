...
const DEFAULT_TRACKER = path.join(
  repoRoot,
  "data-pipelines/docs/sovrn_commerce/sovrn_commerce_apparel_triage_tracker.csv",
);
const DEFAULT_CALIBRATION = path.join(
  repoRoot,
  "data-pipelines/docs/sovrn_commerce/sovrn_commerce_calibration_batch.csv",
);
const DEFAULT_OUTPUT = path.join(
  repoRoot,
  "data-pipelines/docs/sovrn_commerce/sovrn_commerce_calibration_results.csv",
);
const DEFAULT_ALL_OUTPUT = path.join(
  repoRoot,
  "data-pipelines/docs/sovrn_commerce/sovrn_commerce_full_tracker_triage_results.csv",
);
