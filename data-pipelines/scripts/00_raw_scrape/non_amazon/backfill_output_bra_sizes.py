...
from pipeline_paths import fwm_data_dir  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--root", type=Path, default=default_outputs_root(), help="Review/output package root to scan.")
