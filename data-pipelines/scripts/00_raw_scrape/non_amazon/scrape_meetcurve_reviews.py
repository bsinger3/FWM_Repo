...
Output is written to:
    FWM_Data/00_raw_scraped_data/meetcurve/legacy_pre_2026-06-15/
"""
...
PIPELINE_SCRIPTS_DIR = ROOT / "data-pipelines" / "scripts"
if str(PIPELINE_SCRIPTS_DIR) not in sys.path:
    sys.path.insert(0, str(PIPELINE_SCRIPTS_DIR))

from pipeline_paths import raw_scraped_data_root  # noqa: E402

OUTPUT_DIR = raw_scraped_data_root() / "meetcurve" / "legacy_pre_2026-06-15"
