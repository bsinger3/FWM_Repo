...
REASON_CODE_COLUMNS = {
    ...
    "final_reason_code": {"NO_PERSON", "MULTIPLE_PEOPLE", "LOW_BODY_COVERAGE", "SUBJECT_TOO_SMALL", "CLEAR_PASS", "MISSING_CV_DATA", "BORDERLINE_BODY_COVERAGE", "BORDERLINE_SUBJECT_SIZE", "BORDERLINE_NO_FACE", "BORDERLINE_COMPOSITION", "HUMAN_OVERRIDE"},
}
