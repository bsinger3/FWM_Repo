...
FWM_ROOT = REPO_ROOT.parent
DATA_ROOT = FWM_ROOT / "FWM_Data"
AMAZON_MANUAL_CHUNKS = DATA_ROOT / "amazon/data/step_4_human_review_and_visibility_decisions/manual_chunks"
NON_AMAZON_RAW = DATA_ROOT / "non-amazon/data/step_1_raw_scraping_data"
SORTER_RESULTS = REPO_ROOT / "outputs/cv_experiments/fit_image_sorter_2026_05_27/fit_image_sorter_results.csv"
OUT_DIR = REPO_ROOT / "outputs/supabase_production_image_review_2026_05_28_s3_refresh_sovrn_prioritized"
SOVRN_CANDIDATES = REPO_ROOT / "data-pipelines/non-amazon/docs/sovrn_commerce_scrape_triage_candidates.csv"
SOVRN_TRACKER = REPO_ROOT / "data-pipelines/non-amazon/docs/sovrn_commerce_apparel_triage_tracker.csv"
...
def base_output_row(
    ...
    output = {
        ...
        "weight_lbs_display": row.get("weight_lbs_display") or row.get("weight_display_display", ""),
