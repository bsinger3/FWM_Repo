...
DEFAULT_REPORT_ROOT = DEFAULT_OUTPUTS_ROOT / "measurement_coverage"
...
SOURCE_SPECS = (
    SourceSpec(
        ...
        "cv_gated_all",
        "02_supabase_needs_human_review_cv_first_pass/partial_170000_rows_cv_gated/cv_gate_checkpoint_parts/full_cv_gate_part_*.csv",
        "csv",
        50,
    ),
    SourceSpec(
        ...
        "human_labeled",
        "02_supabase_needs_human_review_cv_first_pass/human_labeled_returns/human_labeled_*.xlsx",
        "xlsx",
        10,
    ),
    SourceSpec(
        ...
        "ready_human_approved",
        "01_supabase_ready_human_approved/**/approved_rows/*.csv",
        "csv",
        20,
    ),
    SourceSpec(
        ...
        "ready_labeled_source",
        "01_supabase_ready_human_approved/**/labeled_source/*.csv",
        "csv",
        30,
    ),
    SourceSpec(
        ...
        "unprocessed",
        "03_supabase_unprocessed_not_cv_or_human/unprocessed_rows_part_*.csv",
        "csv",
        60,
    ),
)
