...
- Plan: `data-pipelines/non-amazon/docs/sovrn_commerce_scraping_triage_plan.md`
- Full tracker: `data-pipelines/non-amazon/docs/sovrn_commerce_apparel_triage_tracker.csv`
- Calibration batch: `data-pipelines/non-amazon/docs/sovrn_commerce_calibration_batch.csv`

Implementation:

- Script: `data-pipelines/non-amazon/scripts/triage_sovrn_commerce_calibration.mjs`
- Output: `data-pipelines/non-amazon/docs/sovrn_commerce_calibration_results.csv`
